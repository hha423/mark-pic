...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <>
    <header className={`h-12 border-b flex items-center justify-between px-2 sm:px-4 relative z-50 transition-colors duration-300 ${
      isDarkMode
      ...
      <div className="flex items-center space-x-1 sm:space-x-2">
        <button
          ...
          className={`flex items-center p-1.5 sm:px-3 sm:py-1.5 text-sm rounded-md transition-all duration-200 ${
            isDarkMode
